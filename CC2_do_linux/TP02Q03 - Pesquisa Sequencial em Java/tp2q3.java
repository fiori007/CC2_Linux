...
class Serie {
    ...
    public void printClass() {
        //System.out.println(this.name + " " + this.format + " " + this.duration + " " + this.country + " " + this.language
...
public class tp2q3 {
    ...
    public static boolean search(String s, String vet[]) {
        boolean resp = false;
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            if (isFim(s) == false) {
                try {
                    teste[i] = new Serie();
                    teste[i].readClass("/tmp/series/" + s);
                    vet[i] = teste[i].getName();
                } catch (Exception e) {
                }
            }
            i++;
